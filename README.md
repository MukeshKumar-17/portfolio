# Mukesh Kumar Kannan - Portfolio Website
...
- **Matrix Theme**: Inspired by the iconic digital rain effect
- **Color Palette**: Strategic use of red (#ff0000) and black (#000000)
- **Typography**: Monospace font for that authentic coding feel
...
### Styling
Modify the design in `src/index.css`:
